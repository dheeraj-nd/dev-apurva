const featurecarousel = document.querySelector('.featurecarousel');
    ...
    const featureindicators = document.querySelectorAll('.featureindicator');
    const leftArrow = document.querySelector('.featurearrow.left');
    const rightArrow = document.querySelector('.featurearrow.right');
